...
import com.gooey.network.net.cookie.GooeySerializableHttpCookie;import java.io.ByteArrayInputStream;
 ...
 */
public class GooeyPersistentCookieStore implements GooeyCookieStore {
    ...
    public GooeyPersistentCookieStore(Context context) {
    ...
    private void saveCookie(HttpUrl url, Cookie cookie, String name) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + name, encodeCookie(new GooeySerializableHttpCookie(cookie)));
        prefsWriter.apply();
    }
     ...
     * @return 序列化之后的string
     */
    private String encodeCookie(GooeySerializableHttpCookie cookie) {
    ...
    private Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((GooeySerializableHttpCookie) objectInputStream.readObject()).getCookie();
        } catch (IOException e) {
